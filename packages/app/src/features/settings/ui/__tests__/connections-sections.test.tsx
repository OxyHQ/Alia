...
vi.mock('@/features/connections/runtime/use-connected-accounts', () => ({
  useConnectedAccounts: () => mocks.accounts,
}));
vi.mock('@/features/connections/runtime/use-bots', () => ({ useBots: () => mocks.bots }));
vi.mock('@/features/connections/runtime/use-integrations', () => ({
