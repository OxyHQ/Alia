 ...
 */
vi.mock('@/features/chat/runtime/use-catalogue', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/chat/runtime/use-catalogue')>();
...
vi.mock('@/features/chat/runtime/model-store', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/features/chat/runtime/model-store')>();
  return {
    ...actual,
