...
import { errorMessage as getErrorMessage, errorStatus } from '@/shared/api/error-utils';
import { createRandomUuid } from '@/shared/platform/random-uuid';
import { normalizeConversationMessages } from '@/features/chat/model/chat-message-history';
...
export interface Message {
   ...
   * `turnLifecycle` in `src/features/chat/model/thought-utils.ts` reads the outcome off the tool
   * states instead.
   */
