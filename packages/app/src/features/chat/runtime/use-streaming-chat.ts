...
import type { UsageWarning } from '@/features/chat/runtime/use-credit-warnings';
import { collectDeviceInfo } from '@/shared/platform/device-info';
...
export function useStreamingChat(apiUrl: string, conversationId?: string, reasoningEffort?: EffortLevel | null, selectedModel?: string, agentId?: string | null) {
   ...
   * retry — or `null`. See `src/features/chat/ui/turn-failure.ts` for why a
