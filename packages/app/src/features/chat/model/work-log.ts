...
import { extractCitationSources } from '@/features/research/model/citations';
import { getToolDoneLabel, getToolPillLabel } from '@/features/chat/model/task-utils';
import { toolCallStatus } from '@/features/chat/model/thought-utils';
 ...
 * a card, titled from `task-utils.ts`.
 *
