 ...
 *
 * Everything here is pure. `src/features/chat/runtime/use-timeline-window.ts` holds the state
 * and talks to the thread; `src/features/chat/ui/chat-interface.tsx` draws the rows.
 *
