...
vi.mock('@/features/skills/ui/skill-cover-canvas-skia', () => {
...
const { SkillCover } = await import('@/features/skills/ui/skill-cover');
const { default: WebCanvas } = await import('@/features/skills/ui/skill-cover-canvas.web');
const { GRID_SIZE, hashSeed, generatePalette, generateGrid, computeCellColor } = await import(
  '@/features/skills/ui/skill-cover-palette'
);
