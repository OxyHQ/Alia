...
vi.mock('@/lib/hooks/agents/use-agent-thread-actions', () => ({}));
...
import { agentChatRoute } from '@/lib/agents/identity';
import { agentShareMessage } from '@/lib/hooks/agents/use-agent-detail-actions';
