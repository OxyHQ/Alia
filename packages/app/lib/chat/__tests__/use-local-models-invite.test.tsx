...
vi.mock('@/lib/hooks/use-is-large-screen', () => ({ useIsLargeScreen: () => env.isLargeScreen }));
vi.mock('@/lib/hooks/use-translation', () => ({ useTranslation: () => ({ t: (key: string) => key }) }));

import { LOCAL_MODELS_INVITE_TOAST_ID, useLocalModelsInvite } from '@/lib/chat/use-local-models-invite';
