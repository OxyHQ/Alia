import { KnowledgePickerDialog } from '@/components/agents/edit/knowledge-picker-dialog';
import { SkillPickerDialog } from '@/components/agents/edit/skill-picker-dialog';
