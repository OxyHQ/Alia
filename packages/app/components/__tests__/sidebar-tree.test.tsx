...
vi.mock('@/components/invite-dialog', () => ({ InviteDialog: () => null }));
vi.mock('@/components/project-edit-dialog', () => ({ ProjectEditDialog: () => null }));
...
vi.mock('@/lib/hooks/use-my-agents', () => ({ useMyAgents: () => ({ data: state.agents }) }));
vi.mock('@/lib/hooks/use-notifications', () => ({ useUnreadCount: () => ({ data: undefined }) }));
