 ...
 * shared instance. That matters more here than in `packages/integrations` —
 * `alia` will live on the SHARED `oxy-postgres` instance beside five other
 * services' databases, so a mistyped connection string has somewhere wrong to
 * point.
 */
