...
describe('writeContentChunk', () => {
  it('tags the chunk with alia_meta when meta is given', () => {
    ...
    writeContentChunk(res, 'chatcmpl-test', 'route:auto', 'brief interruption', { synthetic: true, retryable: true });
  ...
  it('omits alia_meta entirely when no meta is given', () => {
    ...
    writeContentChunk(res, 'chatcmpl-test', 'route:auto', 'a real answer');
