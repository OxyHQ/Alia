...
const FEATURES: FeatureSeed[] = [
  ...
  { featureId: 'api-access', label: 'API access', description: 'Programmatic access to Alia via REST API', category: 'Features', featureType: 'boolean', sortOrder: 21, isVisibleOnPricing: true },
