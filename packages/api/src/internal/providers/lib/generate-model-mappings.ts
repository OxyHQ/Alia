...
export const GENERATED_TIER_MAPPINGS: Record<AliaTier, ModelMapping[]> = {
  'lite': [
    ...
    createMapping('xai', 'xai', 'grok-4-fast', 'grok-4-fast', 5, 70),
  ...
  'v1': [
    ...
    createMapping('xai', 'xai', 'grok-4-fast', 'grok-4-fast', 4, 82),
  ...
  'v1-codea': [
    ...
    createMapping('xai', 'xai', 'grok-4-fast', 'grok-4-fast', 4, 91),
  ...
  'v1-cowork': [
    ...
    createMapping('xai', 'xai', 'grok-4-fast', 'grok-4-fast', 5, 88),
  ...
  'v1-browser': [
    ...
    createMapping('xai', 'xai', 'grok-4-fast', 'grok-4-fast', 6, 89),
  ...
  'v1-vision': [
    ...
    createMapping('xai', 'xai', 'grok-4', 'grok-4', 5, 90),
  ...
  'v1-pro': [
    ...
    createMapping('xai', 'xai', 'grok-3', 'grok-3', 4, 93),
  ...
  'v1-pro-max': [
    ...
    createMapping('xai', 'xai', 'grok-4', 'grok-4', 4, 94),
