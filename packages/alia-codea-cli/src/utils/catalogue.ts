 ...
 * workstream 5).
 *
 * The CLI used to bake `route:code` into four command definitions, a session
 ...
 * expanded to `route:pro-standard` whether or not such a thing existed. This module is
 ...
 * catalogue's own.
 *
 * The CLI printed `Model: Instant` — the display name of the alias a routing
 ...
 *
 * This replaces `args[0].startsWith('alia-') ? args[0] : \`route:auto-${args[0]}\``,
 ...
 * `route:pro-standard` WITHOUT the CLI knowing that name in advance. An ambiguous or
