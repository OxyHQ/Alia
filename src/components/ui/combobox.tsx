...
import { ArrowDown01Icon, Cancel01Icon, CheckmarkCircle01Icon } from "@hugeicons/core-free-icons"
import { createIcon } from "@/components/ui/hugeicon"

const ArrowDown01 = createIcon(ArrowDown01Icon)
const Cancel01 = createIcon(Cancel01Icon)
const Tick02 = createIcon(CheckmarkCircle01Icon)
...
function ComboboxTrigger({
  ...
  return (
    ...
    >
      {children}
      <ArrowDown01 strokeWidth={2} className="text-muted-foreground size-4 pointer-events-none" />
    </ComboboxPrimitive.Trigger>
  )
}
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      {...props}
    >
      <Cancel01 strokeWidth={2} className="pointer-events-none" />
    </ComboboxPrimitive.Clear>
  )
}
...
function ComboboxItem({
  ...
  return (
    ...
    >
      ...
      >
        <Tick02 strokeWidth={2} className="pointer-events-none" />
      </ComboboxPrimitive.ItemIndicator>
    </ComboboxPrimitive.Item>
  )
}
