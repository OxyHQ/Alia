...
function MessageBubble({ message, isStreaming }: { message: Message; isStreaming?: boolean }) {
  ...
  return (
    <div className="flex gap-3">
      <img src="/codea-logo.png" alt="Cowork" className={cn("size-6 shrink-0 rounded-full", isStreaming && !message.content && "animate-pulse")} />
  ...
  return (
    <div className="flex min-h-full flex-col items-center justify-center gap-6 p-8 text-center">
      <div className="flex flex-col items-center gap-4">
        <img src="/codea-logo.png" alt="Cowork" className="size-16 rounded-full" />
        <div>
