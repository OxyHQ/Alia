/**
 * Model Resolver for Telegram Gateway
 *
 ...
 * the gateway to use AI SDK directly without format conversion.
 */
...
export async function resolveModel(
  ...
  try {
    const response = await fetch(url, {
      ...
      body: JSON.stringify({ model: aliaModelId, clientType: 'telegram-gateway' })
    });
