...
This guide covers production deployment for the current Alia runtime (unified chat + trigger engine + autonomy).
...
# Integrations bridge
INTEGRATIONS_SERVICE_URL=https://integrations.alia.onl
...
# Sandbox runtime
DOCKER_HOST_URL=https://docker-host.alia.onl
