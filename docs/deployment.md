...
4. Automation create and manual run work via `/automations`; legacy `/triggers` writes
   and webhook execution return `410`, while historical reads remain available.
