...
- **Auth**: `@oxyhq/core ^3.11.0`, `@oxyhq/auth ^5.1.1`, `@oxyhq/services ^11.1.0`, `@oxyhq/bloom ^0.19.1`, `@oxyhq/contracts ^0.3.0` (transitive via core)
